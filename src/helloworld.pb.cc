...
void helloworld::SerializeWithCachedSizes(
  ...
  // optional int64 opt = 3;
  if (has_opt()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(3, this->opt(), output);
  }
...
::google::protobuf::uint8* helloworld::SerializeWithCachedSizesToArray(
  ...
  // optional int64 opt = 3;
  if (has_opt()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(3, this->opt(), target);
  }
