...
class helloworld : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int64 opt() const;
  inline void set_opt(::google::protobuf::int64 value);
...
inline ::google::protobuf::int64 helloworld::id() const {
  return id_;
}
inline void helloworld::set_id(::google::protobuf::int64 value) {
  set_has_id();
  id_ = value;
}
...
inline void helloworld::clear_opt() {
  opt_ = GOOGLE_LONGLONG(0);
  clear_has_opt();
}
inline ::google::protobuf::int64 helloworld::opt() const {
  return opt_;
}
inline void helloworld::set_opt(::google::protobuf::int64 value) {
  set_has_opt();
  opt_ = value;
}
